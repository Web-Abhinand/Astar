...
export default function ControllerPanel({ changeGraph, nodesAndLinks, changeGraphType, manual, setManual,setNodesAndLinks}) {
    ...
    const handleManualLink = () => {
        ...
        let link = { source: sourceNodeToBeAdded[0], target: targetNodeToBeAdded[0], value: value,gOfN:gofn};
        ...
        <div className="gap-10 shadow-sm shadow-gray-700 tracking-widest p-5 bg-blue m-4">
           ...
           <div style={{display:'flex',justifyContent:'space-between'}} className="my-5">
            ...
            {manual ? <>
                ...
                <div style={{display:'flex',justifyContent:'space-between'}}>
                    <input type="text" placeholder="h(n)" className="input input-bordered input-accent bg-white placeholder-gray-800 my-4 " 
                    value={hofn}
                    onChange={(e)=>{
                        setHofn(e.target.value);
                    }}></input>
                    <input type="text" placeholder="g(n)" className="input input-bordered input-accent bg-white placeholder-gray-800 my-4 " 
                    value={gofn}
                    onChange={(e)=>{
                        setGofn(e.target.value);
                    }}></input>
                </div>
